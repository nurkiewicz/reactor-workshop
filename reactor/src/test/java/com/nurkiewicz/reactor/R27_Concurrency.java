...
public class R27_Concurrency {

	private static final Logger log = LoggerFactory.getLogger(R27_Concurrency.class);
		...
		final Flux<Html> htmls = domains
				.flatMap(domain ->
						Mono
								...
								.subscribeOn(crawlerScheduler), Crawler.MAX_CRAWLERS);
